  ...
  return (
    <div className ='about'>
        ...
        <div className = 'about-right'>
            ...
            <p>Whether you aspire to become a teacher, administrator, councelor, or educational leader, our diverse range of programs offfers the perfect pathway to achieve your goals and unlock your full potential in shaping the future of education.</p>
        </div>
    </div>
  )
}
